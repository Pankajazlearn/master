...
variable "tag_Environment" {
  type        = string
  description = "SQS tag Environment"

}

variable "tag_Project" {
  type        = string
  description = "SQS tag Project"

}

variable "tag_Owner" {
  type        = string
  description = "SQS tag Owner"

}

variable "tag_BusinessUnit" {
  type        = string
  description = "SQS tag BusinessUnit"

}

variable "tag_OpCo" {
  type        = string
  description = "SQS tag OpCo"

}

variable "tag_Confidentiality" {
  type        = string
  description = "SQS tag confidentiality"
