...
module "az_vm_backup" {
  source              = "./vm_backup/"
  resource_group_name = module.az_virtual_network.az_virtual_network_output.resource_group_name
  location            = module.az_virtual_network.az_virtual_network_output.location
  virtual_machine_id  = module.az_compute.az_virtual_machine.id
